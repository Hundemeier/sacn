...
class receiverThread(threading.Thread):
    ...
    def run(self):
        ...
        while self.enabled_flag:
            ...
            # receive the data
            try:
                raw_data, _ = list(self.socket.recvfrom(1144))  # 1144 because the longest possible packet
            ...
            except TypeError:  # try to make a DataPacket. If it fails just go over it
                continue
